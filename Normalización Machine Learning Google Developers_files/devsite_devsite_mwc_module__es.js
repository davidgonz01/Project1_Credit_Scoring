...
_ds.zH(a);return b}});var AZ=function(a){return a.label?(0,_ds.P)`<span class="devsite-mwc__label ${a.required?"devsite-mwc__label--required":""}">${a.label}</span>`:_ds.lx},BZ=function(a){return a.icon?(0,_ds.P)`<span class="devsite-mwc-text-field__icon">
      ...
      <select aria-labelledby="label"
              ...
              ?required="${a.required}"
              ?readonly="${a.readOnly}"
              name="${_ds.Mz(""===a.name?void 0:a.name)}"
              @change="${b=>{a.o(b);a.h(b)}}"
              @blur="${a.j}"
              @focus="${a.N}">
        ${a.options.map(b=>(0,_ds.P)`
      ...
      </span>`},DZ=class extends _ds.by{constructor(){super();this.readOnly=!1;this.kind="";this.type="text";this.disabled=this.warning=this.required=this.outlined=!1;this.name=this.value=this.placeholder=this.icon=this.label="";this.invalid=this.focused=!1;this.rows=2;this.cols=20;this.maxLength=this.minLength=-1;this.charCounter=!1;this.staticPath="";this.options=[]}static get styles(){return yZ}kc(a){super.kc(a);(a=Array.from(this.querySelectorAll("option")).map(b=>({value:b.value,text:b.text,
disabled:b.disabled})))&&a.length&&""!==a[0].text&&""!==a[0].value&&a.unshift({value:"",text:"",disabled:!0});this.options=a;_ds.Sx(this)}update(a){a.has("value")&&"string"!==typeof this.value&&(this.value=`${this.value}`);super.update(a)}j(a){this.value=a.target.value.trim();this.focused=!1;""===this.value&&(this.warning=!1)}N(a){this.value=a.target.value.trim();this.focused=!0}o(a){this.value=a.target.value.trim();this.invalid=!1;this.required&&""===this.value?this.invalid=!0:this.value&&(0<this.minLength&&
this.value.length<this.minLength&&(this.invalid=!0),0<this.maxLength&&this.value.length>this.maxLength&&(this.invalid=!0))}h(a){const b=new CustomEvent("change");a&&(this.value=a.target.value.trim());this.dispatchEvent(b)}focus(){const a=new CustomEvent("focus");let b;null==(b=this.rf)||b.dispatchEvent(a);let c;null==(c=this.rf)||c.focus();let d;null==(d=this.Zf)||d.dispatchEvent(a);let e;null==(e=this.Zf)||e.focus();let f;null==(f=this.Mf)||f.dispatchEvent(a);let g;null==(g=this.Mf)||g.focus()}blur(){const a=
new CustomEvent("blur");let b;null==(b=this.rf)||b.dispatchEvent(a);let c;null==(c=this.rf)||c.blur();let d;null==(d=this.Zf)||d.dispatchEvent(a);let e;null==(e=this.Zf)||e.blur();let f;null==(f=this.Mf)||f.dispatchEvent(a);let g;null==(g=this.Mf)||g.blur()}select(){let a;null==(a=this.rf)||a.select();let b;null==(b=this.Mf)||b.select()}render(){switch(this.kind){case "textfield":var a=(0,_ds.fJ)({"devsite-mwc-text-field--with-leading-icon":this.icon,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,
"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--warning":this.warning,"devsite-mwc--floating":""!==this.value||this.focused}),b=AZ(this),c=BZ(this);const g=-1===this.minLength?void 0:this.minLength,h=-1===this.maxLength?void 0:this.maxLength;var d=this.type,e=zZ(this.value),f=""===this.name?void 0:this.name;return(0,_ds.P)`
      ...
      <input
          ...
          minlength="${null!=g?g:_ds.lx}"
          maxlength="${null!=h?h:_ds.lx}"
          name="${null!=f?f:_ds.lx}"
          @input="${this.o}"
          @blur="${this.j}"
          @focus="${this.N}"
          @change="${this.h}">`}
      </label>
    `;case "select":a:{for(a of this.options)if(a.value.trim()===this.value.trim()){a=a.text.trim();break a}a=""}return(0,_ds.P)`
        <label class="devsite-mwc-select ${(0,_ds.fJ)({"devsite-mwc--disabled":this.disabled,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==a||this.focused})}">
        ${AZ(this)}
        ${BZ(this)}
        ${CZ(this)}
      </label>
    `;case "textarea":return a=(0,_ds.fJ)({"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==this.value||this.focused}),b=AZ(this),e=-1===this.minLength?void 0:this.minLength,f=-1===this.maxLength?void 0:this.maxLength,c=zZ(this.value),d=""===this.name?void 0:this.name,(0,_ds.P)`
        <label class="devsite-mwc-text-area ${a}">
          ...
          rows="${this.rows}"
          cols="${this.cols}"
          name="${null!=d?d:_ds.lx}"
          minlength="${null!=e?e:_ds.lx}"
          maxlength="${null!=f?f:_ds.lx}"
          @input="${this.o}"
          @blur="${this.j}"
          @focus="${this.N}"
          @change="${this.h}"></textarea>`}
        </label>
        ${!this.charCounter&&this.maxLength?_ds.lx:(0,_ds.P)`<span class="devsite-mwc-character-counter">${Math.min(this.value.length,this.maxLength)} / ${this.maxLength}</span>`}
    `;default:return(0,_ds.P)`<span>Invalid element type</span>`}}};_ds.y([_ds.Vo("input"),_ds.z(HTMLInputElement)],DZ.prototype,"rf",void 0);_ds.y([_ds.Vo("select"),_ds.z(HTMLSelectElement)],DZ.prototype,"Zf",void 0);_ds.y([_ds.Vo("textarea"),_ds.z(HTMLTextAreaElement)],DZ.prototype,"Mf",void 0);_ds.y([_ds.K({type:Boolean}),_ds.z(Object)],DZ.prototype,"readOnly",void 0);_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"kind",void 0);
_ds.y([_ds.K({type:String}),_ds.z(String)],DZ.prototype,"type",void 0);_ds.y([_ds.K({type:Boolean}),_ds.z(Object)],DZ.prototype,"outlined",void 0);_ds.y([_ds.K({type:Boolean,Da:!0}),_ds.z(Object)],DZ.prototype,"required",void 0);_ds.y([_ds.K({type:Boolean,Da:!0}),_ds.z(Object)],DZ.prototype,"warning",void 0);_ds.y([_ds.K({type:Boolean,Da:!0}),_ds.z(Object)],DZ.prototype,"disabled",void 0);_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"label",void 0);
_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"icon",void 0);_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"placeholder",void 0);_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"value",void 0);_ds.y([_ds.K({type:String}),_ds.z(Object)],DZ.prototype,"name",void 0);_ds.y([_ds.K({type:Boolean}),_ds.z(Object)],DZ.prototype,"focused",void 0);_ds.y([_ds.K({type:Boolean,Da:!0}),_ds.z(Object)],DZ.prototype,"invalid",void 0);
_ds.y([_ds.K({type:Number}),_ds.z(Object)],DZ.prototype,"rows",void 0);_ds.y([_ds.K({type:Number}),_ds.z(Object)],DZ.prototype,"cols",void 0);_ds.y([_ds.K({type:Number}),_ds.z(Object)],DZ.prototype,"minLength",void 0);_ds.y([_ds.K({type:Number}),_ds.z(Object)],DZ.prototype,"maxLength",void 0);_ds.y([_ds.K({type:Boolean}),_ds.z(Object)],DZ.prototype,"charCounter",void 0);_ds.y([_ds.K({type:String,Da:!0}),_ds.z(Object)],DZ.prototype,"staticPath",void 0);try{window.customElements.define("devsite-mwc",DZ)}catch(a){console.warn("Unrecognized DevSite custom element - DevsiteMwc",a)};})(_ds_www);
